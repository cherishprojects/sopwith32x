...
unsigned short currentFB = 0;

void Hw32xSetFGColor8bit(int s)
{
    fgs = s;
}

void Hw32xSetBGColor8bit(int s)
{
    bgs = s;
}

void Hw32xSetFGColor16bit(int r, int g, int b)
{
    fgc = COLOR(r, g, b);
}

void Hw32xSetBGColor16bit(int r, int g, int b)
{
    bgc = COLOR(r, g, b);
}

void Hw32xSetPaletteColor(int s, int r, int g, int b)
{
